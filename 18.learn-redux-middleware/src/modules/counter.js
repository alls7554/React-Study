...
// // 1초 뒤에 increase 혹은 decrease 함수를 디스패치합니다.
...
function* increaseSaga() {
  ...
  const number = yield select(state => state.counter); // state는 스토어 상태를 의미합니다.
...
const initialState = 0; // 상태가 꼭 객체일 필요가 없습니다. 숫자도 작동합니다.
